...
import wis.mapper.StudyProgramMapper;
...
public class StudyProgramController {
	...
	@Autowired
	StudyProgramMapper spm;
	
	
	@RequestMapping()
	public ResponseEntity<List<StudyProgramDTO>> getAllStudyProgram() {
		List<StudyProgram> studyProgram = sps.getStudyProgram();	
		return ResponseEntity.ok(spm.toDTO(studyProgram));
	}
	@RequestMapping(value="/facultyid", method=RequestMethod.GET)
	public ResponseEntity<List<StudyProgramDTO>> getAllStudyProgramByFaculty(Long id){
		List<StudyProgram> studyProgram = sps.getAllByFacultyId(id);
		return ResponseEntity.ok(spm.toDTO(studyProgram));
	}
